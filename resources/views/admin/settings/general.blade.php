                    ...
                    <div class="card-body">
                        <form class="" method="POST" action="/admin/settings/general">
                            ...
                            <div class="form-group">
                                <label for="input-title">Bussiness Name </label>
                                <input id="input-title" type="text"
                                    class="form-control form-control-lg @error('site_title') is-invalid @enderror"
                                    name="site_title" value="{{ old('site_title', $general_setting->site_title) }}"
                                    required autocomplete="site_title" autofocus placeholder="Enter Site Title">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-address1" type="text"
                                    ...
                                    autocomplete="address_1" autofocus placeholder="Enter Address">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-address2" type="text"
                                    ...
                                    autocomplete="address_2" autofocus placeholder="Enter Address">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-city" type="text"
                                    ...
                                    value="{{ old('city', $general_setting->city) }}" required autocomplete="city"
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-state" type="text"
                                    ...
                                    value="{{ old('state', $general_setting->state) }}" required autocomplete="state"
                                    autofocus placeholder="Enter State">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-state" type="text"
                                    ...
                                    autocomplete="zipcode" autofocus placeholder="Enter Zip Code">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-phone-number" type="text"
                                    class="form-control form-control-lg @error('phone_number') is-invalid @enderror"
                                    name="phone_number" value="{{ old('phone_number', $general_setting->phone_number) }}"
                                    required autocomplete="phone_number" autofocus placeholder="Enter Phone Number">

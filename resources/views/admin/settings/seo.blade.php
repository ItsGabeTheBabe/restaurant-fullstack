                        ...
                        <form class="" method="POST" action="/admin/settings/seo">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-description" type="text"
                                    ...
                                    name="description" value="{{ old('description', $seo_setting->description) }}"
                                    required autocomplete="description" autofocus placeholder="Enter Description">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input-keywords" type="text"
                                    ...
                                    autocomplete="keywords" autofocus placeholder="Enter Keywords">

...
class FoodCategorySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('food_categories')->insert([
            ...
            Sequi omnis iste ab deleniti cupiditate architecto officia aspernatur nulla iusto delectus doloremque possimus recusandae, 
            reiciendis aliquam vel voluptas repellendus natus nihil?',
